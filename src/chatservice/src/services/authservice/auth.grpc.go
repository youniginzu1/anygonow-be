...
import (
	...
	"github.com/aqaurius6666/chatservice/src/pb/authpb"
...
// func (s ServiceGRPC) RegisterOTP(ctx context.Context, otpId string) (id, mail, phone string, role c.ROLE, err error) {
...
// 		return
// 	}
// 	return res.Id, res.Mail, res.Phone, res.Role, nil
// }
...
// 	}
// 	if !res.Ok {
// 		return 0, xerrors.Errorf("%w", e.ErrOTPFail)
// 	}
// 	return res.Type, nil
// }
...
// func (s ServiceGRPC) Register(ctx context.Context, mail, phone, pub, enpriv string, role c.ROLE) (otpId string, err error) {
...
// func (s ServiceGRPC) GetCredential(ctx context.Context, data string) (id, pub, priv string, err error) {
...
// 		return
// 	}
// 	return res.Credential.Id, res.Credential.PublicKey, res.Credential.EncryptedPrivateKey, nil
// }
