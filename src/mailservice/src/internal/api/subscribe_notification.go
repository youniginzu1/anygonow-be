...
func (s *ApiServer) SubscribeNotification(ctx context.Context, req *mailpb.SubscribeNotificationRequest) (*mailpb.SubscribeNotificationResponse, error) {
	...
	return s.Model.SubscribeNotification(ctx, req)
}
